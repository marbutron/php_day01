...
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=tcp enable=yes profile=public
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=udp enable=yes profile=public
...
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=tcp enable=yes profile=domain
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=udp enable=yes profile=domain
...
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=tcp enable=yes profile=private
cmd /c netsh advfirewall firewall add rule name="SunloginClient" dir=out action=allow program="%CD%\SunloginClient.exe" protocol=udp enable=yes profile=private
...
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=tcp enable=yes profile=public
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=udp enable=yes profile=public
...
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=tcp enable=yes profile=domain
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=udp enable=yes profile=domain
...
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=tcp enable=yes profile=private
cmd /c netsh advfirewall firewall add rule name="SunloginDesktopAgent" dir=out action=allow program="%CD%\agent\SunloginClient.exe" protocol=udp enable=yes profile=private
:end